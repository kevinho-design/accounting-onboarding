...
export function ExceptionFirstDashboard({ onReviewFinancialGoals, onRecentActionsChange, onExceptionsChange, onAskTeammate }: ExceptionFirstDashboardProps) {
  ...
  // Mock exceptions - in real app, would be fetched from backend
  const exceptions: Exception[] = [
    {
      ...
      description: "$73,700 revenue at risk",
      impact: "Could delay cash runway by 7 days if not collected",
      suggestedAction: "Send payment reminders",
      data: {
        invoices: [
          { client: "Acme Corp", amount: 32500, daysOverdue: 18, matter: "Contract Dispute" },
          { client: "Tech Solutions", amount: 24200, daysOverdue: 15, matter: "IP Litigation" },
          { client: "Global Industries", amount: 17000, daysOverdue: 12, matter: "Employment Matter" }
        ]
      },
    ...
    },
    {
      ...
      agentId: "matching",
      severity: "high",
      title: "14 bank transactions need review",
      description: "Unable to auto-match with 95%+ confidence",
      impact: "Reconciliation incomplete for March 17",
      suggestedAction: "Review and categorize manually",
      data: {
        transactions: [
          { date: "Mar 17", vendor: "Unknown Vendor LLC", amount: 1250, similarity: 67 },
          { date: "Mar 16", vendor: "ACH Transfer 8472", amount: 3400, similarity: 45 }
        ]
      },
    ...
    },
    {
      ...
      description: "74 days current vs 90-day goal",
      impact: "$52.5K in aged unbilled time could extend runway by 12 days",
        ...
        <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          {showMigrationBanner && (
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 mb-12"
            >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xl font-semibold text-gray-900">
                        {totalAttentionCount} {totalAttentionCount === 1 ? 'item' : 'items'} need your attention
                      </h2>
                    ...
                    {exceptions.map((exception, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="p-6 bg-white rounded-2xl border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer"
                          onClick={() => setSelectedMetric(exception.id)}
                        >
              ...
              <div className="mb-12">
                ...
                {financialHealthExpanded && (
                  ...
                  >
                    ...
                    <div className="p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl border border-gray-200 mb-6">
                      <div 
                    ...
                    <div className="grid grid-cols-4 gap-6 mb-6">
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 mb-4">March 2026</div>
                        
                        <div className="text-3xl font-bold text-gray-900 mb-2">$142,847</div>
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 mb-4">March 2026 MTD</div>
                        
                        <div className="text-3xl font-bold text-gray-900 mb-2">$284,500</div>
                        <div className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 rounded text-xs font-medium text-emerald-700 mb-4">
                          <TrendingUp className="w-3 h-3" />
                          +12% MoM
                        </div>
                        ...
                        <div className="flex items-end justify-between h-16 gap-0.5 mb-3">
                          {[
                            // Week 1: Mar 1-7 (Sat-Fri)
                            { height: 25, day: 1 }, // Sat
                            { height: 15, day: 2 }, // Sun
                            { height: 65, day: 3 }, // Mon
                            { height: 70, day: 4 }, // Tue
                            ...
                            { height: 20, day: 8 }, // Sat
                            { height: 18, day: 9 }, // Sun
                            { height: 75, day: 10 }, // Mon
                            { height: 78, day: 11 }, // Tue
                            { height: 80, day: 12 }, // Wed
                            { height: 76, day: 13 }, // Thu
                            { height: 70, day: 14 }, // Fri
                            // Week 3: Mar 15-17
                            { height: 22, day: 15 }, // Sat
                            { height: 16, day: 16 }, // Sun
                            { height: 82, day: 17, isToday: true }, // Tue (Today)
                          ].map((bar, i) => (
                            <div
                              key={i}
                      ...
                      {/* Collections / AR Risk */}
                      <div 
                        className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-yellow-200 hover:shadow-lg transition-all cursor-pointer"
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 mb-4">60+ Days Overdue</div>
                        
                        <div className="text-3xl font-bold text-gray-900 mb-2">$73,700</div>
                        <div className="inline-flex items-center gap-1 px-2 py-1 bg-orange-100 rounded text-xs font-medium text-orange-700 mb-4">
                        ...
                        <div className="space-y-1.5 mb-3">
                          <div className="flex items-end justify-between h-16 gap-1">
                            {[
                              { height: 45, amount: '$142K', label: 'Current', color: 'bg-emerald-200' },
                              { height: 60, amount: '$89K', label: '1-30', color: 'bg-blue-200' },
                              { height: 35, amount: '$54K', label: '31-60', color: 'bg-yellow-200' },
                              { height: 50, amount: '$41K', label: '61-90', color: 'bg-orange-300' },
                              { height: 75, amount: '$74K', label: '90+', color: 'bg-red-400' },
                            ].map((bucket, i) => (
                              <div
                                key={i}
                                className={`flex-1 rounded-t ${bucket.color} transition-all`}
                                style={{ height: `${bucket.height}%` }}
                                title={`${bucket.label} days: ${bucket.amount}`}
                              />
                            ))}
                          </div>
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 mb-4">vs 90-day target</div>
                        
                        <div className="text-3xl font-bold text-gray-900 mb-2">74 Days</div>
                        ...
                        <div className="relative h-16 flex items-end justify-center pb-1 mb-3">
                          <svg className="w-32 h-16" viewBox="0 0 120 55" preserveAspectRatio="xMidYMid meet">
                            {/* Background arc */}
                            <path
                          ...
                          <div className="absolute bottom-0 text-xs text-gray-500">82%</div>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div 
                        className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-purple-200 hover:shadow-lg transition-all cursor-pointer"
                      >
                        <div className="flex items-center justify-between mb-1">
