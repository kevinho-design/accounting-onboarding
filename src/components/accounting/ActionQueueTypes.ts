...
export const cardTypeConfig: Record<CardType, CardTypeConfig> = {
  trust_balance:       { label: "Trust Alert",         icon: AlertTriangle, priority: "critical", viewCTA: "Allocate top-up", secondaryCTA: "Assign to others" },
  bank_disconnect:     { label: "Bank Issue",          icon: WifiOff,       priority: "critical", inlineCTA: "Reconnect" },
  ...
  approval_required:   { label: "Approval Required",   icon: ShieldCheck,   priority: "high",     viewCTA: "Route approval", secondaryCTA: "View details" },
...
export const mockActionCards: ActionCardData[] = [
  // CRITICAL
  {
    ...
    subtitle: "A $1,250 filing fee will leave only $592 in the account",
  ...
  },
  {
    ...
    amount: "$8,420.00",
    status: "new",
    title: "Chase ··4892 lost connection — 12 transactions waiting",
    subtitle: "Re-authenticate to resume syncing",
    evidenceRationale: "Plaid token expired at 11:42 AM. 12 transactions totaling ~$8,420 are queued by Chase but can't sync until the connection is re-established.",
  },
  ...
  // ADDITIONAL CRITICAL
  {
    ...
    subtitle: "Pending $2,800 disbursement to heirs will breach the $1,000 minimum",
  ...
  },
  {
    ...
    subtitle: "A $5,500 distribution would create a $1,250 deficit",
...

  {
    ...
    amount: "$100.00",
    status: "new",
    title: "Unidentified $100 charge on Feb 14",
    subtitle: "We see a $100 charge in your bank statement with no match in your books",
    evidenceRationale: "After reconciling March, we found a $100 charge dated Feb 14 in the Chase ··4892 bank statement with no corresponding transaction in your books. This may be an unreported expense.",
    txnContext: { payee: "Unknown vendor", category: "Uncategorized", date: "Feb 14, 2026", source: "Chase ··4892", sourceIcon: "bank" },
    hidden: true,
  },
  {
    id: "l4",
