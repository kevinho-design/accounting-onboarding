...
export const mockActionCards: ActionCardData[] = [
...

  {
    ...
    amount: "$2,858.19",
    status: "new",
    title: "Feb operating recon blocked — $2,858.19 unmatched charge",
    subtitle: "Bank statement shows a $2,858.19 charge on Feb 14 with no matching entry in your books",
    evidenceRationale: "We automatically downloaded your Chase ··4892 February statement and cross-referenced all 312 transactions. 311 matched perfectly. This $2,858.19 charge on Feb 14 has no corresponding entry. We recommend adding it as a miscellaneous expense to complete reconciliation.",
