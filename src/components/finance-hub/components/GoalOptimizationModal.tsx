        ...
        <div className="p-6 pb-4 shrink-0 border-b border-gray-100">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600 text-sm">
              Choose what this goal measures, name it for your team, and set targets with benchmark and Clio Accounting
              context.
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar">
          ...
          <section className="rounded-[8px] border border-violet-200 bg-violet-50/60 p-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-[11px] font-bold text-violet-700 uppercase tracking-widest">Clio Accounting insight</h4>
            </div>
